...
CREATE INDEX IF NOT EXISTS idx_pengaduan_nik ON pengaduan(nik_masyarakat);
...
CREATE INDEX IF NOT EXISTS idx_notifikasi_is_read ON notifications(is_read);
CREATE INDEX IF NOT EXISTS idx_notifikasi_user ON notifications(user_id, user_type, is_read, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_tanggapan_pengaduan ON tanggapan(id_pengaduan);
CREATE INDEX IF NOT EXISTS idx_masyarakat_email ON masyarakat(email);
CREATE INDEX IF NOT EXISTS idx_petugas_email ON petugas(email);
CREATE INDEX IF NOT EXISTS idx_pengaduan_wilayah ON pengaduan(kecamatan, kelurahan);
CREATE INDEX IF NOT EXISTS idx_pengaduan_prioritas ON pengaduan(prioritas);
