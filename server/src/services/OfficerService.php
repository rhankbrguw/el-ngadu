...
class OfficerService {
    ...
    public function createOfficer(array $data): void {
        ...
        if (!empty($data['email'])) {
            ...
            EmailService::getInstance()->sendEmailAsync($data['email'], AppMessages::EMAIL_SUBJECT_WELCOME_OFFICER, AppMessages::EMAIL_TITLE_WELCOME_OFFICER, $content, AppMessages::EMAIL_BTN_LOGIN, rtrim($appUrl, '/') . AppMessages::ROUTE_LOGIN);
        }
    }
