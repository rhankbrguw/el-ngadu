...
export function Navbar() {
 ...
 <Link
 to="/"
 className="text-xl font-bold flex items-center gap-3 hover:text-secondary/80 transition-colors"
 >
 <img
 ...
 variant="ghost"
 size="icon"
 className="text-muted-foreground hover:text-foreground hover:bg-card transition-colors"
