    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed bottom-20 sm:bottom-24 right-3 sm:right-6 left-3 sm:left-auto w-auto sm:w-96 h-[70vh] sm:h-96 max-h-[550px] z-50 flex flex-col shadow-2xl rounded-2xl overflow-hidden border border-border"
        >
