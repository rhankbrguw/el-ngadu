...
ALTER TABLE tanggapan RENAME COLUMN created_at TO tgl_tanggapan;
ALTER TABLE tanggapan RENAME COLUMN tanggapan TO isi_tanggapan;
UPDATE petugas SET password = '$2y$12$zn6jUMecjOMiO8V8dFyPU.Ob45icHuaerruK4wHjLuG3WnTHu750a' WHERE username = 'admin';
UPDATE pengaduan SET status = 'diajukan' WHERE status = '0';
UPDATE pengaduan SET status = 'diproses' WHERE status = 'proses';
